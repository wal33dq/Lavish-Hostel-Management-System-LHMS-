...
urlpatterns = [
    ...
    path('warden/create_student_user/', views.create_student_user, name='create_student_user'),  # New URL
    path('warden/update_student_cnic/<int:student_id>/', views.update_student_cnic, name='update_student_cnic'),  # New URL
    path('warden/update_student_emergency_contact/<int:student_id>/', views.update_student_emergency_contact, name='update_student_emergency_contact'),  # New URL
